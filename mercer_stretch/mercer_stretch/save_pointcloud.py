...
class PCDListener(Node):
    ...
    def __init__(self):
        ...
        self.save_timer = self.create_timer(10, self.save_pcd_callback)
        self.get_logger().info("PCD Listener Node Initialized")
        self.save_counter = 0
    ...
    def save_pcd_callback(self):
        o3d.io.write_point_cloud(f"/home/hello-robot/mercer_ws/src/mercer_stretch/assets/pointcloud{self.save_counter}.pcd", self.o3d_pcd)
        self.get_logger().info("Saved point cloud to pointcloud.pcd")
        self.save_counter += 1
